USE mydatadb;
#1.Creating the 1st table "EMPLOYEE"
...
#2.inserting the values to its respective entities
...
# as ‘Increased Salary’select JOB_ID as 'JOB_TITLE' from EMPLOYEE group by JOB_ID;
...
# compensation.
select LAST_NAME,SALARY,SALARY + 100 as 'Annual_Compensation' from EMPLOYEE;
